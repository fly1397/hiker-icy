        ...
        var js = $.toString(()=> {
            ...
            const tokenFunction = function () {
                ...
                if(isShare) {
                    ...
                    if(!location.href.startsWith('https://auth.aliyundrive.com')) {
    ...
    videoProxy: function(file_id, share_id, share_token, zimuItem, drive_id, file_data){
        ...
        if(json.code && json.message) {
            if(json.code.includes('AccessTokenInvalid')) {
                ...
                return this.videoProxy(file_id, share_id, share_token, drive_id);
                // eval(fetch('hiker://files/rules/icy/ali.js'));
            ...
            tid.forEach((value, index) => {
                ...
                if (!!_link) {
                    ...
                    if(share_id) {
                        ...
                        playLink = 'http://116.85.31.19:4000/apis/yun-play/'+_d+'/'+access_token+'/'+share_token+'/'+value+'/index.m3u8';
                    } else if(drive_id) {
                        playLink = 'http://116.85.31.19:4000/apis/my-yun-play/'+file_id+'/'+drive_id+'/'+access_token+'/'+value+'/index.m3u8';
                    }
        ...
        rescod.items.forEach((_item, index) => {
            ...
            switch(category || type){
                case 'video':
                    ...
                    let file_data = JSON.parse(JSON.stringify(_data));
                    if(typeof expiration != 'undefined') {
                        file_data.expiration = expiration;
                    }
                    file_data.expiration = expiration;
                    ...
                    if(fnName == 'rule') {
                        ...
                        videolazy = $('hiker://empty' + file_id).lazyRule((shareId, sharetoken, file_id, fnName, zimuItemList, file_data) => {
                            ...
                            if(access_token) {
                                let zimuItem = null;
                                if(zimuItemList && zimuItemList.length == 1) {
                        ...
                        }, shareId, sharetoken, file_id, fnName, zimuItemList, file_data)
                    }
                    d.push({
                        title: '🎬 ' + title,
